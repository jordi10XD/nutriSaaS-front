...
// Importaciones corregidas (asegúrate de que los nombres coincidan EXACTO con los archivos)
import Login from './login';
import AdminDashboard from './AdminDashboard';
import NutriDashboard from './component/nutri/NutriDashboard'; // <--- IMPORTAR
