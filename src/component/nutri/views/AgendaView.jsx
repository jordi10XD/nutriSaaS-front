...
const AgendaView = () => {
  ...
  const [events, setEvents] = useState([
    { id: 1, patient: 'Juan Pérez', type: 'Online', start: new Date(new Date().setHours(9, 0, 0, 0)), duration: 60, status: 'confirmado' },
    { id: 2, patient: 'Maria Gonzalez', type: 'Presencial', start: new Date(new Date().setHours(11, 30, 0, 0)), duration: 45, status: 'pendiente' },
    { id: 3, patient: 'Carlos Ruiz', type: 'Online', start: addDays(new Date().setHours(15, 0, 0, 0), 1), duration: 90, status: 'confirmado' },
    { id: 4, patient: 'Ana López', type: 'Presencial', start: addDays(new Date().setHours(10, 0, 0, 0), 2), duration: 60, status: 'pendiente' },
    { id: 5, patient: 'Roberto Gomez', type: 'Online', start: addDays(new Date().setHours(16, 0, 0, 0), 10), duration: 30, status: 'confirmado' },
  ]);
